...
namespace FHIR_json.Controllers
{
    public class FHIRController : Controller
    {
        ...
        [HttpPost]
        public Bundle LABD_JSON(List<OriginalJson.LABD> jsonString) //ActionResult
        {
        ...
        public ActionResult TOTFA_JSON()
        {
        ...
        public ActionResult TOTFB_JSON()
        {
